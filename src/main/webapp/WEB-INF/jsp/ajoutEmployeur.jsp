        ...
        <div class="card mb-4" id="cadre">
            <div class="container text-center">
                ...
                <div class="flex-grow-1 cadre-info my-3 mx-3">
                    <h2 class="mb-1"><spring:message code="employeur.ajouter" /> pour l'agent 1</h2>
                </div>

                    <div class="form-group g-mb-25 px-3">
                        <label for="exampleSelect1">Rechercher un employeur</label>
                        <div class="formfield-select--container">
                            <select class="form-control rounded-0 formUA" id="exampleSelect1">
                            <option>Employeur 1</option>
                            <option>Employeur 2</option>
                            <option>Employeur 3</option>
                            <option>Employeur 4</option>
                            <option>Employeur 5</option>
                            </select>
                        </div>
                    </div>
                    <br>
